...
try{
  ...
  console.error("Firebase匿名認証に失敗しました。",error);
  if(connectionStatus) connectionStatus.textContent="認証エラー";
  if(connectionCard) connectionCard.classList.add("is-error");
  alert("Firebaseへの認証に失敗しました。通信環境を確認して、再度開いてください。");
  return;
}
